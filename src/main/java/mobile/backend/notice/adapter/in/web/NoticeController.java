...
public class NoticeController {
  ...
  @GetMapping("/home")
  public BaseResponse<NoticeResponse> getHomeNotice(@AuthenticationPrincipal CustomUserDetails userDetails) {
    Notice notice = noticeQueryUseCase.getHomeNotice(userDetails.getUserId());
  ...
  @PostMapping("/{noticeId}/ignore")
  public BaseResponse<Void> ignoreNotice(
      @AuthenticationPrincipal CustomUserDetails userDetails,
      @PathVariable Long noticeId
  ) {
    noticeCommandUseCase.ignoreNotice(userDetails.getUserId(), noticeId);
